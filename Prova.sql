...
BEGIN
	...
	SELECT @ultimo_cliente = Nome FROM Clientes ORDER BY ID_Cliente ASC 
...
--Essa Subquery retorna o sálário somado, da tabela funcionários, de acordo com a carga horária
